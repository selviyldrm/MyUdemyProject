...
using HotelProject.BusinessLAaer.Concrete;
...
namespace HotelProjectWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(opt => //bir apinin baþka kaynaklar tarafýndan tüketilmesini saðlar
            {
                opt.AddPolicy("OtelApiCors", opts =>
                {
                    opts.AllowAnyOrigin().AllowAnyHeader().AllowAnyMethod(); //herhangi  bir kaynaða izin verir
                });
            });
